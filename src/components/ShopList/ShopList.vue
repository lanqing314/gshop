        ...
        <ul class="shop_list">
            ...
            <a>
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  <h4 class="shop_title ellipsis">西施冒菜</h4>
          ...
          <li class="shop_li border-1px">
            <a>
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  <h4 class="shop_title ellipsis">螺狮粉</h4>
                  <ul class="shop_detail_ul">
                    <li class="supports">保</li>
                    <li class="supports">准</li>
                    <li class="supports">票</li>
                ...
                <section class="shop_rating_order">
                  <section class="shop_rating_order_left">
                    ...
                    <div class="order_section">月售50单</div>
                  </section>
                  <section class="shop_rating_order_right">
                    <span class="delivery_style delivery_right">硅谷专送</span>
                  </section>
          ...
          <li class="shop_li border-1px">
            <a>
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  <h4 class="shop_title ellipsis">杨国福</h4>
                  <ul class="shop_detail_ul">
                    <li class="supports">保</li>
                    <li class="supports">准</li>
                    <li class="supports">票</li>
                ...
                <section class="shop_rating_order">
                  <section class="shop_rating_order_left">
                    ...
                    <div class="rating_section">3.4</div>
                    <div class="order_section">月售200单</div>
                  </section>
                  <section class="shop_rating_order_right">
                    <span class="delivery_style delivery_right">硅谷专送</span>
                  </section>
          ...
          <li class="shop_li border-1px">
            <a>
              ...
              <div class="shop_right">
                <section class="shop_detail_header">
                  <h4 class="shop_title ellipsis">重庆鸡公煲</h4>
                  <ul class="shop_detail_ul">
                    <li class="supports">保</li>
                    <li class="supports">准</li>
                    <li class="supports">票</li>
                ...
                <section class="shop_rating_order">
                  <section class="shop_rating_order_left">
                    ...
                    <div class="rating_section">4.6</div>
                    <div class="order_section">月售120单</div>
                  </section>
                  <section class="shop_rating_order_right">
                    <span class="delivery_style delivery_right">硅谷专送</span>
                  </section>
